...
(function() {
  'use strict';
  var Cache, ConntrackSS, Mtr, Tracer, add_task, add_task_now, assert, child_process, domain, dump, events, fs, geoip, k, opts, path, proj, stream, svg, throw_err, util, v, yaml,
  ...
  ConntrackSS = (function(_super) {
    ...
    ConntrackSS.prototype.start = function(poll_interval, now) {
      ...
      return this.timer = (function(self) {
        var scheduler;
        scheduler = now ? add_task_now : add_task;
  ...
  (function() {
    ...
    return add_task_now(opts.config.updates.redraw, function() {
      var traces;
